...
using UnityEngine;
#endif
public class SimControllerHeroOnlineMCTS : SimControllerHero {
...
//	public static int TREE_SEARCH_TIME = 100;
	...
	public SimControllerHeroOnlineMCTS() {

	}
	public SimControllerHeroOnlineMCTS(BaseProgram evaluationFunction) {
	...
	public override SimHeroAction NextAction(SimLevel level, int msPerMove){
        Tree tree = new Tree(level, C, UtilityFunction, EvaluationFunction, SimControllerHeroOnlineMCTS.rolloutCount);
        tree.MaxHeight = 60;
        tree.MAX_TREE_SIZE = MAX_TREE_SIZE;
