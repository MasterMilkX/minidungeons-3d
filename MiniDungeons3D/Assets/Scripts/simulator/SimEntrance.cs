public class SimEntrance : SimGameCharacter{
	
	public SimEntrance(bool alive, SimPoint priorPoint, SimPoint point, int health, int damage){
		CharacterType = GameCharacterTypes.Entrance;
	...
	public SimEntrance(SimEntrance other){
	...
	public override SimGameCharacter Clone(){
		var clone = new SimEntrance(this);
		return clone;
	}

	public override bool Equals(object obj){
		var other = (SimEntrance) obj;
