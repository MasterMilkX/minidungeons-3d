public class SimTreasure : SimGameCharacter{
	
	public SimTreasure(bool alive, SimPoint priorPoint, SimPoint point, int health, int damage){
		CharacterType = GameCharacterTypes.Treasure;
	...
	public SimTreasure(SimTreasure other){
	...
	public override SimGameCharacter Clone(){
		var clone = new SimTreasure(this);
		return clone;
	}

	public override bool Equals(object obj){
		var other = (SimTreasure) obj;
